        ...
        <div class="col-md-10 mx-auto">
            <div class="card">
                <div class="card-header">
                    <span>Pengguna</span>
                    <a href="<?= base_url('user/create') ?>" class="btn-secondary btn-sm">Tambah</a>
                        ...
                        foreach ($content as $row) : $no++; ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus?')">
