<nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
    <div class="container">
        <a class="navbar-brand" href="<?= base_url('') ?>">Roda Maju</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <?php if ($this->session->userdata('role') == 'admin') { ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-1">
                            ...
                            <a href="<?= base_url('service') ?>" class="dropdown-item">Service</a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('keranjang') ?>" class="nav-link"><i class="fas fa-shopping-cart"></i> Booking Service (<?= getCart(); ?>)</a>
                </li>
                ...
                <?php else : ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-2">
                            ...
                            <a href="<?= base_url('/mybooking') ?>" class="dropdown-item">Orders</a>
